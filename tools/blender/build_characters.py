...
a sculpted head with a painted face, the body warped from the base mesh (hero_base.py, ref/hero_male.glb)
...
CHARACTERS = ['xiaopei', 'tangtang', 'weibao', 'fang', 'folk_a', 'folk_b', 'folk_c']
